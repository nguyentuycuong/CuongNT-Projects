...
using oHoob.Authorization;
using oHoob.Helpers;
using oHoob.ViewModels;
...
namespace oHoob
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("oHoob"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "oHoob API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "oHoob API V1");
            });
